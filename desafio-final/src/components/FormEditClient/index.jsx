...
function FormEditClient({ handleSubmit, showClientModal, setShowClientModal }) {
  const {
    inputName,
    inputEmail,
    inputCPF,
  ...
  return (
    ...
    >
      <div className='flex-row'>
        <img className='form-modal-icon-client' src={iconClient} />
        <h1 className='form-modal-title'>Editar Cliente</h1>
        <img
      ...
      <div className='flex-column relative'>
        ...
        />
        {error.name && <span className='error-inputs'>{error.name}</span>}
      </div>
      <div className='flex-column relative'>
      ...
      <div className='div-form-flex-row flex-row'>
        <div className='flex-column relative'>
          ...
          <input
            ...
            onChange={(e) => handleChangeInput(e)}
          />
          {error.cpf && <span className='error-inputs'>{error.cpf}</span>}
        </div>
        <div className='flex-column relative'>
